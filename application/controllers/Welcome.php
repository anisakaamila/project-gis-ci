...
class Welcome extends CI_Controller 
{
	...
	public function index()
	{
		...
		$marker['infowindow_content'] .= '<img src="'.base_url("public/image/{$value->photo}").'" class="media-object" style="width:200px">';
		$marker['infowindow_content'] .= '</div>';
		$marker['infowindow_content'] .= '<div class="media-body">';
		$marker['infowindow_content'] .= '<h4 class="media-heading">'.$value->name.'</h4>';
		$marker['infowindow_content'] .= '<h6 class="media-heading">Rp. '.number_format($value->price).'</h6>';
		$marker['infowindow_content'] .= '<p>Alamat : '.$value->address.'</p>';
		$marker['infowindow_content'] .= '<p>'.$value->amenities.'</p>';
		$marker['infowindow_content'] .= '</div>';
		$marker['infowindow_content'] .= '</div>';
