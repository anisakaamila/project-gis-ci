	...
	<footer class="page-break-top">
		...
		<div class="container">
			<div class="row">
				...
				<div class="hr5"></div>
				<div class="col-md-12">
					<p class="text-center"><small>Hak Cipta <strong>Politeknik Elektronika Negeri Surabayas</strong> &copy; 2021 <a href="http://vicky.work">[http://vicky.work]</a>. All Right Reserved</small></p>
				</div>
			</div>
		</div>
	</footer>
